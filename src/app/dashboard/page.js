...
import EditButton from '../components/EditButton' // We'll create this client component
                    ...
                    <div className="container mx-auto max-w-7xl ">
                        <div className='flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-8 mt-14'>
                            ...
                            <div className='bg-[#26235c] fade-in w-full max-w-[538px] lg:w-[538px] h-auto min-h-[717px] lg:h-[717px] mx-auto rounded-[30px] sm:rounded-[50px] mt-4 sm:mt-10 relative px-4 py-6 sm:px-6 sm:py-8 '>
                                ...
                                {/* Social Links */}
                                <div className="quickLinks mt-8 sm:mt-16 lg:mt-16 w-full max-w-[408px] mx-auto px-4">
                            ...
                            <div className="w-full lg:w-auto lg:flex-1 lg:max-w-md">
                                <EditButton session={session} User={User} />
                            </div>
                        </div>
                    </div>
                </main>
